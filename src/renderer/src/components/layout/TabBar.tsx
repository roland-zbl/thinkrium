...
export const TabBar: React.FC = () => {
    ...
    const [confirmClose, setConfirmClose] = useState<{ open: boolean; tab: Tab | null }>({ open: false, tab: null });
            ...
            >
                {tabs.map((tab) => {
                    ...
                    return (
                        ...
                        >
                            <Icon size={14} className={cn(isActive ? "text-primary" : "text-muted-foreground/40")} />
