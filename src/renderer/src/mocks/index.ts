...
export const mockFeedItems = [
  {
    ...
    content: '完整內容：這篇文章詳細討論了 AI 在程序化生成、NPC 對話以及美術自動化生產中的突破。儘管目前仍有技術邊度，但 Larian 等大廠已經開始嘗試...'
  },
  {
    id: 'item-2',
    ...
    content: 'Swen Vincke 表示：我們不想重複自己。柏德之門3 是個巔峰，但我們已經在嘗試新的敘事機制。這次的重點會放在「動態後果」系統上。'
  }
];
...
export const mockNotes = [
  ...
  { id: 'note-2', title: 'Larian公開下一款遊戲方向', date: '2026-01-06', type: 'note', projects: ['vol.40'], tags: ['遊戲', 'AI'] },
  { id: 'note-3', title: '任天堂Q3財報', date: '2026-01-05', type: 'note', projects: ['vol.40'], tags: ['遊戲'] },
];
