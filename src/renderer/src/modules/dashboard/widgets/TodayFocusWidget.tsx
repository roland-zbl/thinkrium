            ...
            <div className="grid grid-cols-2 gap-4 flex-1">
                ...
                <div className="flex flex-col justify-center gap-1 rounded-xl bg-gradient-to-br from-background to-warning/5 p-4 border border-black/5 dark:border-white/5 relative overflow-hidden shadow-sm">
                    ...
                    <div className="flex items-center gap-1.5 mb-1">
                        ...
                        <span className="text-[10px] uppercase text-warning font-bold tracking-wider">最緊急專案</span>
                    </div>
                    {mostUrgentProject ? (
                        <>
                            <span className="text-sm font-bold text-foreground truncate">{mostUrgentProject.title}</span>
