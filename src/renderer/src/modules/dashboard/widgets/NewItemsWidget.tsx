        ...
        >
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-bold text-foreground group-hover:text-primary transition-colors">最新資訊</h3>
                </div>
                {unreadCount > 0 && (
            ...
            <div className="space-y-4">
                {latestItems.length > 0 ? (
                    latestItems.map(item => (
                        <div key={item.id} className="flex items-center gap-3 text-sm text-foreground/70 group-hover:text-foreground transition-colors">
                    ...
                    <div className="flex flex-col items-center justify-center py-6 gap-3 text-muted-foreground">
                        ...
                        <span className="text-sm font-medium italic text-muted-foreground/80">目前環境一片和諧</span>
                    </div>
                )}
            </div>
