...
export const AddSubscriptionDialog: React.FC<Props> = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex items-center justify-between p-4 border-b" style={{ borderColor: tokens.colors.bgSubtle }}>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-muted-foreground uppercase">顯示名稱 (選填)</label>
                        <input
                            value={name}
