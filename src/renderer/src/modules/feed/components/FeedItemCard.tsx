    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground uppercase font-bold tracking-tight mb-1">
                <span className={cn(isActive ? "text-primary" : "text-muted-foreground")}>{item.source}</span>
            ...
            <h3 className={cn(
                ...
                item.status === 'unread' ? "font-bold text-foreground" : "font-medium text-muted-foreground",
